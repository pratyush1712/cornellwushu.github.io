...
function returnAvatar(mem) {
  try {
    ...
    return <Avatar src={notFound} alt={mem.members.fullName} />;
  }
}
...
function PastPerf(props) {
  ...
  const streamURL =
    "https://2ec2615c32b8.us-east-1.playback.live-video.net/api/video/v1/us-east-1.951388478060.channel.GyudoC5s8aIt.m3u8";
        ...
        >
          <Box sx={style}>
            ...
            <Typography variant="subtitle2" sx={{ mb: 2 }}>
              ...
              {new Date(performance.date.replace("-", "/")).toDateString()}
            </Typography>
                  ...
                  return (
                    <>
                      <ListItem
                        ...
                        key={mem.members.fullName}
                        sx={{
                          width: "100%",
                          cursor: "pointer",
                          ":hover": {
                            transition: "smooth",
                            transform: "scale3d(1.025, 1.025, 1.40)",
                            width: "80%",
                          },
                        }}
                        component={Link}
                        href={
                          mem.members.instagram
                            ? mem.members.instagram
                            : mem.members.facebook
                        }
                        target={"_blank"}
                      >
                        <ListItemAvatar>{returnAvatar(mem)}</ListItemAvatar>
                        <ListItemText
                          sx={{ color: "black" }}
          ...
          return (
            <Card
              ...
              sx={{
                ...
                "&:hover": {
                  transition: "smooth",
                  transform: "scale3d(1.015, 1.015, 1.40)",
                },
              }}
            >
              <CardMedia
              ...
              <CardContent>
                ...
                <Typography variant="caption">
                  {new Date(perf.date.replace("-", "/")).toDateString()}
                </Typography>
                <CardActions sx={{ ml: -1 }}>
                  <AvatarGroup
                    max={4}
                    sx={{
                      ...
                      ":hover": {
                        transition: "smooth",
                        transform: "scale3d(1.5, 1.5, 1.40)",
                        position: "relative",
                        ml: 4,
                      },
                    }}
