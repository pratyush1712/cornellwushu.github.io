  ...
  return (
    <Grid item xs={12} sm={12} md={3}>
      <Card
        ...
        sx={{
          marginRight: { sm: 3, md: 3 },
          marginBottom: { xs: 4, sm: 4, md: 8 },
          ":hover": { boxShadow: 5 },
        }}
      >
        {returnImage(member)}
        ...
        >
          ...
          {member.eboardPosition && (
            <Typography variant="subtitle1">
              <strong>{member.eboardPosition}</strong>
            </Typography>
          )}
...
function Member(props) {
  ...
  useEffect(() => {
    if (props.members.currentMember) {
      ...
      minYear.current = parseInt(
        Object.keys(props.members.alumni).sort((a, b) => a - b)[0]
      );
      let yers = [];
      ...
      <Container justifycontent={"center"}>
            ...
            {years.map((year) => (
              <MenuItem
                ...
                sx={{
                  ...
                  mt: 1,
                  ":hover": { borderColor: fontColorPrimary },
                }}
              >
                {year - 1} - {year}
              </MenuItem>
          ...
          >
            <Box sx={style}>
              <Stack
                ...
                width={"100%"}
                sx={{ maxHeight: "100%", msOverflowY: "scroll" }}
              >
                <Card
                  sx={{
                ...
                >
                  ...
                  >
                    ...
                    {display.eboardPosition && (
                      <Typography variant="subtitle1">
                        <strong>Position:</strong> {display.eboardPosition}
                      </Typography>
                    )}
                    <Typography variant="subtitle1">
                      <strong>Member Since:</strong> {display.yearJoined}
                    </Typography>
                    <Typography variant="subtitle1">
                      <strong>Major:</strong> {display.majorAndMinor}
                    </Typography>
                    <Typography variant="subtitle1">
                      <strong>Graduation Year:</strong> {display.graduationYear}
                    </Typography>
                  </CardContent>
                ...
                <Card
                  sx={{
                    ...
                    p: 2,
                    minWidth: 400,
                    bgcolor: bgColorSecondaryNoBlur,
                    height: "inherit",
                ...
                >
                  <Stack flexDirection="column" alignContent={"space-between"}>
                    ...
                    <Grid item xs={12}>
                      <Typography variant="subtitle1" sx={{ alignSelf: "end" }}>
                        <strong>Fun Fact:</strong>{" "}
                        {display.fullName === "Pratyush Sudhakar" ? (
                          <code>{display.funFact}</code>
                        ) : (
                          display.funFact
                        )}
                      </Typography>
                      ...
                      >
                        <Box
                          sx={{ ...style, flexDirection: "column" }}
                          bgcolor={bgColorSecondaryNoBlur}
                        >
                          <Typography variant="h5" sx={{ mb: 2 }}>
                            {display.fullName}'s Performances
                          </Typography>
                                    ...
                                    <ListItem
                                      ...
                                      sx={{
                                        ...
                                        ":hover": {
                                          transition: "smooth",
                                          transform:
                                            "scale3d(1.025, 1.025, 1.40)",
                                          width: "80%",
                                        },
                                      }}
                                      href={pref.performances.url}
                                      target={"_blank"}
                                      key={pref.performances.date}
                                    >
                                      <ListItemAvatar>
                                        <Avatar
                                          sx={{ bgcolor: fontColorPrimary }}
                                        >
                                          {
                                            pref.performances.eventName.split(
                                              " "
                                            )[0][0]
                                          }
                                        </Avatar>
        ...
        {year === new Date().getFullYear() + 1 && (
          <>
            ...
            <Grid container>
              {data.currentEboard
                .sort((a, b) => a.locationOnWebPage - b.locationOnWebPage)
                .map((member) => {
